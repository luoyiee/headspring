...
public class CustomMonthView extends MonthView {
    ...
    public CustomMonthView(Context context) {
        ...
        mSolarTermTextPaint.setColor(ContextCompat.getColor(context, R.color.primary_blue));
        ...
        mSchemeBasicPaint.setColor(ContextCompat.getColor(context,R.color.air_3));
        ...
        mPointPaint.setColor(ContextCompat.getColor(context,R.color.primary_blue));
    ...
    protected void onDrawText(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme, boolean isSelected) {
        ...
        int color = ContextCompat.getColor(getContext(), R.color.primary_blue);
...
//            canvas.drawText("休", x + mItemWidth - mPadding - mCircleRadius, y + mPadding + mSchemeBaseLine, mTextPaint);
//        }

        //当然可以换成其它对应的画笔就不麻烦，
        if (calendar.isWeekend() && calendar.isCurrentMonth()) {

            mCurMonthTextPaint.setColor(color);
            mCurMonthLunarTextPaint.setColor(color);
            mSchemeTextPaint.setColor(color);
            mSchemeLunarTextPaint.setColor(color);
            mOtherMonthLunarTextPaint.setColor(color);
            mOtherMonthTextPaint.setColor(color);
        } else {
