package cc.xiaojiang.headerspring.view;
...
public class CommonTextView extends AppCompatTextView {
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        //corner
        mCornerRadius = a.getDimensionPixelSize(R.styleable.CommonTextView_corner_radius, -1);
        mCornerRadiusTopLeft = a.getDimensionPixelSize(R.styleable.CommonTextView_corner_radius_top_left, 0);
        mCornerRadiusTopRight = a.getDimensionPixelSize(R.styleable.CommonTextView_corner_radius_top_right, 0);
        mCornerRadiusBottomLeft = a.getDimensionPixelSize(R.styleable.CommonTextView_corner_radius_bottom_left, 0);
        mCornerRadiusBottomRight = a.getDimensionPixelSize(R.styleable.CommonTextView_corner_radius_bottom_right, 0);
        //border
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mIconNormal = a.getDrawable(R.styleable.CommonTextView_icon_src_normal);
            mIconPressed = a.getDrawable(R.styleable.CommonTextView_icon_src_pressed);
            mIconUnable = a.getDrawable(R.styleable.CommonTextView_icon_src_unable);
        } else {
            int normalId = a.getResourceId(R.styleable.CommonTextView_icon_src_normal, -1);
            int pressedId = a.getResourceId(R.styleable.CommonTextView_icon_src_pressed, -1);
            int unableId = a.getResourceId(R.styleable.CommonTextView_icon_src_unable, -1);
        ...
        mIconWidth = a.getDimensionPixelSize(R.styleable.CommonTextView_icon_width, 0);
        mIconHeight = a.getDimensionPixelSize(R.styleable.CommonTextView_icon_height, 0);
        mIconDirection = a.getInt(R.styleable.CommonTextView_icon_direction, ICON_DIR_LEFT);
        //text
        mTextColorNormal = a.getColor(R.styleable.CommonTextView_text_color_normal, getCurrentTextColor());
        mTextColorPressed = a.getColor(R.styleable.CommonTextView_text_color_pressed, getCurrentTextColor());
        mTextColorUnable = a.getColor(R.styleable.CommonTextView_text_color_unable, getCurrentTextColor());
        //background
        mBackgroundColorNormal = a.getColor(R.styleable.CommonTextView_background_normal, 0);
        mBackgroundColorPressed = a.getColor(R.styleable.CommonTextView_background_pressed, 0);
        mBackgroundColorUnable = a.getColor(R.styleable.CommonTextView_background_unable, 0);
        //typeface
        mTypefacePath = a.getString(R.styleable.CommonTextView_text_typeface);
    ...
    public CommonTextView setStateBackgroundColor(int normal, int pressed, int unable) {
    ...
    public CommonTextView setBackgroundColorNormal(int colorNormal) {
    ...
    public CommonTextView setBackgroundColorPressed(int colorPressed) {
    ...
    public CommonTextView setBackgroundColorUnable(int colorUnable) {
    ...
    public CommonTextView setTypeface(String typefacePath) {
    ...
    public CommonTextView setIconNormal(Drawable icon) {
    ...
    public CommonTextView setIconPressed(Drawable icon) {
    ...
    public CommonTextView setIconUnable(Drawable icon) {
    ...
    public CommonTextView setIconSize(int iconWidth, int iconHeight) {
    ...
    public CommonTextView setIconWidth(int iconWidth) {
        this.mIconWidth = iconWidth;
        setIcon();
        return this;
    }
    ...
    public CommonTextView setIconHeight(int iconHeight) {
        this.mIconHeight = iconHeight;
        setIcon();
        return this;
    }
    ...
    public CommonTextView setIconDirection(int iconDirection) {
    ...
    public CommonTextView setTextColorNormal(int textColor) {
    ...
    public CommonTextView setPressedTextColor(int textColor) {
    ...
    public CommonTextView setTextColorUnable(int textColor) {
    ...
    public CommonTextView setBorderWidthNormal(int width) {
    ...
    public CommonTextView setBorderColorNormal(int color) {
    ...
    public CommonTextView setBorderWidthPressed(int width) {
    ...
    public CommonTextView setBorderColorPressed(int color) {
    ...
    public CommonTextView setBorderWidthUnable(int width) {
    ...
    public CommonTextView setBorderColorUnable(int color) {
    ...
    public CommonTextView setCornerRadiusTopLeft(float topLeft) {
    ...
    public CommonTextView setCornerRadiusTopRight(float topRight) {
        this.mCornerRadius = -1;
    ...
    public CommonTextView setCornerRadiusBottomRight(float bottomRight) {
        this.mCornerRadius = -1;
    ...
    public CommonTextView setCornerRadiusBottomLeft(float bottomLeft) {
        this.mCornerRadius = -1;
